...
public class test_t1_exausting_anonymous {
	...
	@Test
	public void testTest_t2_anonymous_1() throws Exception {
		selenium.open("/pybossa/app/caracterizacao");
	...
	@Test
	public void testTest_t2_anonymous_2() throws Exception {
