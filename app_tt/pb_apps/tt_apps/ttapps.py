...
class Apptt_select(app.Apptt):
    def __init__(self, short_name):
        ...
        super(Apptt_select, self).set_template(__setUrl__(
                os.path.dirname(__file__) + os.sep + "templates" + os.sep + "template-select.html"))
       
        super(Apptt_select, self).set_long_description(__setUrl__(
            os.path.dirname(__file__) + os.sep + "templates" + os.sep + "long_description-select.html"))


class Apptt_meta(app.Apptt):
    def __init__(self, short_name):
        super(Apptt_select, self).__init__("Marcação de tabelas", short_name,
                        "Por favor. Marque e descreva as tabelas.",
                        settings.API_KEY, settings.PYBOSSA_URL)
        
        super(Apptt_select, self).set_template(__setUrl__(
                os.path.dirname(__file__) + os.sep + "templates" + os.sep + "template-meta.html"))
       
        super(Apptt_select, self).set_long_description(__setUrl__(
            os.path.dirname(__file__) + os.sep + "templates" + os.sep + "long_description-meta.html"))
