...
. add columns created and user_id
. change type of column message to text
. remove constraint report_app_id_fkey from report table

Revision ID: 2226dcb83c9e
Revises: 1a60055c594d
Create Date: 2014-04-11 17:37:22.822568

"""

# revision identifiers, used by Alembic.
revision = '2226dcb83c9e'
down_revision = '1a60055c594d'
...
def upgrade():
    op.add_column('report', sa.Column('user_id', sa.VARCHAR(30)) )
    op.add_column('report', sa.Column('created', sa.TIMESTAMP()) )
    op.alter_column('report', 'message', nullable=False, type_=sa.TEXT())
    
    op.drop_constraint('report_app_id_fkey', 'report')
