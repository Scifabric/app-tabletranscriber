"""alter column name page from page table

Revision ID: 2c5a716a1a9c
Revises: 2058b843f26f
Create Date: 2014-03-19 10:49:34.487045

"""

# revision identifiers, used by Alembic.
revision = '2c5a716a1a9c'
down_revision = '2058b843f26f'
...
def upgrade():
    op.alter_column('page', 'page', new_column_name='page_num', nullable=False)
