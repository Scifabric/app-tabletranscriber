...
class PBTask_TestCase(unittest.TestCase):
    ...
    def test_init_01(self):
        try:
            ...
            assert e.code == 1
            assert e.msg == "MEB-APPS-1: App with empty name"
    ...
    def test_init_02(self):
        try:
            ...
            assert e.code == 2
            assert e.msg == "MEB-APPS-2: App with empty shortname" 
    ...
    def test_init_03(self):
        try:
            ...
            self.assertTrue(e.msg == "MEB-APPS-3: App with empty description")
    ...
    def test_add_task_03(self):
        try:
            ...
            self.assertEquals(e.msg, "MEB-APPS-6: Task must be priority between 0 and 1")
