...
class TaskFactoryT1_TestCase(unittest.TestCase):
...
class TaskFactoryT2_TestCase(unittest.TestCase):
...
class TaskFactoryT3_TestCase(unittest.TestCase):
...
class TaskFactoryT4_TestCase(unittest.TestCase):
